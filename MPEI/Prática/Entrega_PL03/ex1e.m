...
%valor mais alto para n=4 por causa do racio vogais/numero de letras
%fazendo com que mais palavras geradas sejam palavras validas (vistos que a
%maior parte das palavras de 4 letras contem 2 vogais (mesmo numero de
%vogais disponiveis no nosso diagrama)
