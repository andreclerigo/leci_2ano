...
for i=1:length(filtrado)
    ...
    if(strcmp(chr,'A') | strcmp(chr,'a') | strcmp(chr,'á') | strcmp(chr,'à') | strcmp(chr,'â') | strcmp(chr,'ã')| strcmp(chr,'À'))
        Na= Na+1;
    elseif(strcmp(chr,'M') | strcmp(chr,'m'))
        Nm= Nm+1;
    elseif(strcmp(chr,'O') | strcmp(chr,'o') | strcmp(chr,'ó') | strcmp(chr,'ò') | strcmp(chr,'ô') | strcmp(chr,'õ') | strcmp(chr,'Ò'))
        No= No+1;
